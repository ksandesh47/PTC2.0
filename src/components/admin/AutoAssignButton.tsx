  ...
  return (
    <div className="flex flex-col gap-1">
      <button
        ...
        className="w-full rounded-md border border-(--color-border) bg-(--color-surface) px-3 py-1.5 text-xs font-semibold hover:bg-(--color-navy-50) disabled:opacity-50 disabled:cursor-not-allowed"
      >
